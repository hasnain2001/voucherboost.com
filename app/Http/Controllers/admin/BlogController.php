...
class BlogController extends Controller
{
   ...
   public function checkSlug(Request $request)
    ...
    public function blogs_show() {
        $blogs = Blog::with('user','category','store','language')->select('id','title','image','category_id','user_id','store_id','language_id','created_at','updated_at')->orderby('created_at','desc')->get();
    ...
    public function create() {
       $categories = Categories::orderBy('created_at','desc')->get();
        ...
        return view('admin.Blog.create', compact('categories','langs','stores'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.blog.show')->with('success', 'Blog created successfully.');
    }
    ...
    public function edit($id)
    {
        ...
        $categories = Categories::orderByDesc('created_at')->get();
         $stores = Stores::orderBy('created_at','desc')->get();
        $langs = Language::orderBy('created_at','desc')->get();
        return view('admin.Blog.edit', compact('blog', 'categories','langs','stores'));
    }
