                ...
                <div class="col-lg-10">
                    <div class="card shadow-lg">
                        <div class="card-header bg-primary text-white">
                            <h3 class="card-title mb-0"><i class="fas fa-edit mr-2"></i>Update Slider</h3>
                        </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <form name="UpdateSlider" id="UpdateSlider" method="POST" action="{{ route('admin.slider.update', $slider->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="text" class="form-control" name="title" id="title" value="{{ old('title', $slider->title) }}"  placeholder="Enter slider title">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="status" id="status_active" value="active" {{ old('status', $slider->status) == 'active' ? 'checked' : '' }} required>
                                                    <label class="form-check-label" for="status_active">Active</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="status" id="status_inactive" value="inactive" {{ old('status', $slider->status) == 'inactive' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <textarea class="form-control" name="description" id="description" rows="3"  placeholder="Enter slider description">{{ old('description', $slider->description) }}</textarea>
                                    </div>

                                    <div class="form-group mb-0">
                                        <label for="url" class="form-label">Destination URL <span class="required-asterisk">*</span></label>
                                        <input type="url" class="form-control" name="url" id="url" value="{{ old('url', $slider->url) }}"  placeholder="https://example.com">
                                    </div>
                                </div>
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @if($slider->image)
                                            <img src="{{ asset('uploads/slider/' . $slider->image) }}" class="current-image d-block">
                                        @else
                                            <span class="badge badge-secondary">No image available</span>
                                        @endif
                                    </div>

                                    <div class="preview-image-container" id="imagePreviewContainer">
                                        <span class="text-muted" id="noImageText"><i class="fas fa-image fa-2x mb-2 d-block"></i>No new image selected</span>
