                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="mt-2 text-center" id="imagePreview">
                                            ...
                                            @else
                                                <img src="{{ asset('employee/dist/img/default-store.png') }}" class="img-thumbnail" style="max-height: 150px;" id="previewImage">
                                            @endif
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-info card-outline">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <textarea id="editor" name="content" required>{!! $stores->content !!}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-footer text-right">
                                    ...
                                    <a href="{{ route('employee.stores') }}" class="btn btn-danger px-4 ml-2">
